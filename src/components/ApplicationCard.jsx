        ...
        <Card className="mt-4">
            ...
            <CardHeader>
                <CardTitle className="flex justify-between font-bold">
                    ...
                    <Download className="bg-white text-black rounded-full h-8 w-8 p-1.5 cursor-pointer" size={18}
            ...
            <CardFooter className="flex justify-between"><span> Time : {new Date(application?.created_at).toLocaleString()}</span>

                {
                    isCandidate ? <span className="capitalize font-bold">Status : {application?.status}</span> :
                        (
                            <Select onValueChange={handleStatusChange} defaultOpen={application.status}>
